...
jQuery(function($) {
    ...
    */
    ...
    $(document).bind('keydown', 'shift+t', tabs_navmenu);
    ...
    $('.dropdown-menu a').keydown(function(e) {
        switch (e.which) {
            ...
            case 37: // LEFT
                e.preventDefault();
                $(this).parent().parent().parent().prev().find('.dropdown-toggle').click();
                $(this).parent().parent().parent().prev().find('.dropdown-menu a:first').focus();
                break;
            case 39: // RIGHT
                e.preventDefault();
                $(this).parent().parent().parent().next().find('.dropdown-toggle').click();
                $(this).parent().parent().parent().next().find('.dropdown-menu a:first').focus();
                break;
            case 27: // ESCAPE
                e.preventDefault();
...
*/
function tabs_navmenu() {
    $(".dropdown-toggle:first").click();
    $(".dropdown-toggle:first").parent().find('.dropdown-menu a:first').focus();
    //$(this).find(".dropdown-toggle").click();
    //    $(this).find(".dropdown-toggle").parent().find('.dropdown-menu a:first').focus();
}
